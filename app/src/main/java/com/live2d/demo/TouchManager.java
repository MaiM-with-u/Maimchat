...
public class TouchManager {
     ...
     * 多指触控开始事件
     *
     * @param deviceX1 第一个触点的x
     * @param deviceY1 第一个触点的y
     * @param deviceX2 第二个触点的x
     * @param deviceY2 第二个触点的y
     */
    public void touchesBegan(float deviceX1, float deviceY1, float deviceX2, float deviceY2) {
        lastX1 = deviceX1;
        lastY1 = deviceY1;
        lastX2 = deviceX2;
        lastY2 = deviceY2;

        lastX = (deviceX1 + deviceX2) * 0.5f;
        lastY = (deviceY1 + deviceY2) * 0.5f;

        startX = lastX;
        startY = lastY;

        lastTouchDistance = calculateDistance(deviceX1, deviceY1, deviceX2, deviceY2);
