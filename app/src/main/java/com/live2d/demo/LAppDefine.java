...
public class LAppDefine {
    ...
    /**
     * Flag whether to draw to the target held by LAppView. (If both
     * USE_RENDER_TARGET and USE_MODEL_RENDER_TARGET are true, this variable is
     * given priority over USE_MODEL_RENDER_TARGET.)
     */
